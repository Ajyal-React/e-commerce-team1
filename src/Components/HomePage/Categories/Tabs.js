		...
		<div className="tab">
			<FlexBox>
				...
				<div>
					<FlexBox>
						<a
							className="tabs-cat active-tab"
							name="MOBILES"
							onClick={(e) => handleTaps(e)}
						>
							MOBILES
						</a>
						<a className="tabs-cat" name="LAPTOPS" onClick={(e) => handleTaps(e)}>
							LAPTOPS
						</a>
						<a className="tabs-cat" name="PLAY_STATIONS">
							PLAY STATIONS
						</a>
						<a className="tabs-cat" name="IPADS">
							IPADS
						</a>
						<a className="tabs-cat" name="SCREENS">
							SCREENS
						</a>
						<a className="tabs-cat" name="AIRPODS">
							AIRPODS
						</a>
